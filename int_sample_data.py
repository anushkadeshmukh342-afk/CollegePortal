...
def init_sample_data():
    with app.app_context():
        ...
        # Sample Clubs
        clubs = [
            Club(name='Coding Club', description='Learn programming, participate in hackathons, and build amazing projects together.', contact_person='Arjun Patel', contact_email='codingclub@prpcem.ac.in', meeting_day='Friday', meeting_time='4:00 PM'),
            Club(name='Robotics Club', description='Design, build, and program robots. Participate in national level competitions.', contact_person='Sneha Sharma', contact_email='robotics@prpcem.ac.in', meeting_day='Wednesday', meeting_time='3:30 PM'),
            ...
            Club(name='Photography Club', description='Capture moments, learn photography techniques, and document college events.', contact_person='Priya Singh', contact_email='photography@prpcem.ac.in', meeting_day='Saturday', meeting_time='2:00 PM'),
            Club(name='Music Club', description='Sing, play instruments, and perform at college events and festivals.', contact_person='Amit Gupta', contact_email='music@prpcem.ac.in', meeting_day='Thursday', meeting_time='4:30 PM'),
            ...
            Club(name='Sports Club', description='Organize sports events, tournaments, and promote fitness among students.', contact_person='Coach Rajesh', contact_email='sports@prpcem.ac.in', meeting_day='Daily', meeting_time='6:00 AM'),
            Club(name='Innovation Club', description='Foster entrepreneurship, startup ideas, and innovation projects.', contact_person='Dr. Anil Sharma', contact_email='innovation@prpcem.ac.in', meeting_day='Wednesday', meeting_time='2:00 PM')
        ]
